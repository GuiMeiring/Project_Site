...
$(document).ready(function(){
    $("#buttonPS").dblclick(function(){
        $("#loadingPS").html("<br><br><div class='spinner-border text-danger' role='status'><span class='visually-hidden'>Loading...</span></div>");

    });    
   
});
$(document).ready(function(){
    $("#buttonXB").dblclick(function(){
        $("#loadingXB").html("<br><br><div class='spinner-border text-danger' role='status'><span class='visually-hidden'>Loading...</span></div>");

    });    
   
});
$(document).ready(function(){
    $("#buttonPC").dblclick(function(){
        $("#loadingPC").html("<br><br><div class='spinner-border text-danger' role='status'><span class='visually-hidden'>Loading...</span></div>");

    });    
   
});
$(document).ready(function(){
    $("#buttonCG").dblclick(function(){
        $("#loadingCG").html("<br><br><div class='spinner-border text-danger' role='status'><span class='visually-hidden'>Loading...</span></div>");
